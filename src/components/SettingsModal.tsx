    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 md:p-6 animate-fadeIn">
      ...
      >
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-slate-800 dark:text-slate-200 text-xs sm:text-sm">
          ...
          {onOpenRepoSync && (
            <section className="p-4 rounded-xl border border-teal-200 dark:border-teal-800/80 bg-teal-50/60 dark:bg-teal-950/40 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Sync category folders (Modules, Past Papers, Textbooks, Notes, Documents) with public repository (FelixChanda/Datanurse_repofiles).
                    </p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl text-xs font-bold text-white bg-teal-600 hover:bg-teal-700 shadow-xs transition-colors shrink-0 cursor-pointer"
                >
                  Open Repo Sync
                </button>
              </div>
